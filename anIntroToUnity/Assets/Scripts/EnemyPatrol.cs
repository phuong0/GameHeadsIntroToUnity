...
public class EnemyPatrol : MonoBehaviour
{
    ...
    {
        RaycastHit2D hit = Physics2D.CircleCast(transform.position, detectionRadius, Vector2.right, Mathf.Epsilon, LayerMask.GetMask("Player"));
    ...
    {
        //hit returns the position of the thing that hit it
    ...
    {
        if (theCollider.gameObject.CompareTag("Patrol"))
        {
            Flip();
            chasee = null;
        }
